//a program like this without a function is longer than one with one.
...
public class HeronsFormula {
  public static void main(String[] args) {
    ...
    System.out.println("A triangle with the sides 3,3,3 has area " + a);

    a = triangleArea(9, 9, 9);
    System.out.println(tws + "9,9,9 has area " + a);

    a = triangleArea(3, 4, 5);
    System.out.println("A triangle with the sides 3,4,5 has area " + a);
